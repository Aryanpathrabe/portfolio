...
function Admin() {
    ...
    const payload = {
      ...
      tags:
        typeof projectForm.tags === "string"
          ? (projectForm.tags as unknown as string)
              .split(",")
              .map((t) => t.trim())
          : projectForm.tags,
    }
  ...
  async function uploadImage(file: File) {
    ...
    setProjectForm((prev) => ({ ...prev, img: data.publicUrl }))
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: ac }}>&lt;</span>Admin
          ...
          <input
            ...
            style={{ ...iS, marginBottom: "1rem" }}
            placeholder="Enter password"
          />
          {msg && (
            <p
              style={{ color: ac, fontSize: "0.8rem", marginBottom: "0.75rem" }}
            >
              {msg}
            </p>
          )}
          <button
            ...
            style={{ ...bS, background: ac, color: "#fff", width: "100%" }}
          >
            Login
          </button>
        </div>
          ...
          <div className="admin-grid">
            ...
            >
              ...
              >
                ...
                ] as { label: string key: keyof Project }[]).map(
                  ({ label, key }) => (
                    <div key={key}>
                      ...
                      <input
                        style={iS}
                        value={
                          Array.isArray(projectForm[key])
                            ? (projectForm[key] as string[]).join(", ")
                            : projectForm[key] as string
                        }
                        onChange={(e) =>
                          setProjectForm({
                            ...projectForm,
                ...
                <div>
                  <label style={lS}>Project Image</label>
                  <label
                    style={{
                      display: "block",
                      background: ac,
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProjectForm({ ...projectForm, img: e.target.value })
                    }
                ...
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  <button
                    onClick={saveProject}
                    style={{ ...bS, background: ac, color: "#fff", flex: 1 }}
                  >
        ...
        {tab === "skills" && (
          <div className="admin-grid">
            ...
            >
              ...
              >
                <div>
                  <label style={lS}>Skill Name</label>
                  <input
                    style={iS}
                ...
                <div>
                  <label style={lS}>Level: {skillForm.level}%</label>
                  <input
                    type="range"
                    min={0}
                    max={100}
...
export default function App() {
  ...
  const [dbProjects, setDbProjects] = useState<typeof PROJECTS>(PROJECTS)
  const [dbSkills, setDbSkills] = useState<typeof SKILLS>(SKILLS)
  const [dbLoaded, setDbLoaded] = useState(false)

  useEffect(() => {
    Promise.all([
      supabase.from("projects").select("*").order("num"),
      supabase.from("skills").select("*").order("created_at"),
    ]).then(([{ data: pd, error: pe }, { data: sd, error: se }]) => {
      ...
      if (sd && sd.length > 0) {
        setDbSkills(sd.map((s: any) => ({ name: s.name, level: s.level })))
      }
      setDbLoaded(true)
    })
  }, [])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch("https://api.web3forms.com/submit", {
      ...
      .then((res) => (res.ok ? setSent(true) : setSent(true)))
      .catch(() => setSent(true))
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span style={{ color: accent }}>&lt;</span>Aryan
      ...
      >
        <p className="section-num" style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          <br />
          by building real projects<span style={{ color: "#fff" }}>.</span>
        </h1>
        <div
          style={{
            display: "flex",
        ...
        >
          Currently focused on building simple and clean websites while
          improving my development skills. Always learning and working on new
          projects.
        </p>
      ...
      >
        ...
        >
          <div
            className="two-col-grid about-grid"
            style={{
              display: "grid",
          ...
          >
            <div>
              ...
              >
                I'm a beginner frontend developer with a passion for creating
                clean, well-structured websites. I believe great design starts
                with simplicity — and I'm constantly improving my skills in
                HTML, CSS, and JavaScript to turn ideas into real projects.
              </p>
              <p
                style={{ color: muted, lineHeight: 1.8, marginBottom: "2rem" }}
              >
                Every project I build is a chance to learn something new. Right
                now, I'm focused on writing readable code and building
                interfaces that actually work well on every device.
              </p>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(to top, rgba(13,13,13,0.45) 0%, transparent 55%)",
                  }}
                />
              </div>
            </div>
          ...
          >
            <div>
              ...
              <p style={{ color: "#aaa", lineHeight: 1.8 }}>
                Technologies and tools I'm actively learning and using in real
                projects.
              </p>
            </div>
      ...
      >
        ...
        >
          <div style={{ marginBottom: "4rem" }}>
            ...
            >
              A mix of practice projects and AI-powered UI experiments — all
              honest, all real.
            </p>
            {/* Filter tabs */}
            <div
        ...
        >
          ...
          >
            <div>
              ...
              >
                Feel free to reach out—whether it&apos;s work, curiosity, or
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                {[
                  ...
                  { label: "Instagram", val: "instagram.com/arynn_77" },
                ].map(({ label, val }) => (
                  <div
                    key={label}
                    style={{
                  ...
                  >
                    ...
                    <p style={{ color: "#fafafa", fontSize: "0.88rem" }}>
                      {val}
                    </p>
                  </div>
                ))}
        ...
        >
          ...
          <div style={{ display: "flex", gap: "1.5rem" }}>
            {[
              ...
              {
                label: "LinkedIn",
                url: "https://linkedin.com/in/aryanpathrabe",
              },
